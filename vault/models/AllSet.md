...
<span class="lgn">코드 `AllSet/` · 결과 `results/result_*_AllSet_*.txt` · 갱신 2026-09-15 14:48</span>
...
series:
  - title: 우리
    data: [41.0, 53.1, 40.5, 50.2, 72.5, 29.6]
  - title: 논문
    data: [41.1, 53.6, 41.7, 50.3, 74.1, 29.8]
tension: 0.2
width: 100%
labelColors: false
fill: false
...
series:
  - title: 우리
    data: [50.7, 50.8, 50.6, 53.5, 52.7, 50.5]
  - title: 논문
    data: [51.8, 51.2, 50.3, 53.5, 52.3, 51.0]
tension: 0.2
width: 100%
labelColors: false
fill: false
