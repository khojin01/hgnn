...
<small>코드 `TriCL/` · 결과 `results/result_*_TriCL_*.txt` · 갱신 2026-09-15 15:11</small>

| NC 일치 | HP 일치 | 최대 편차 |
|---|---|---|
| **6/6** | **1/6** | **−5.4** |
| <small>|Δ| 중앙값 1.00</small> | <small>|Δ| 중앙값 4.20</small> | <small>하이퍼엣지 예측 · House</small> |
...
series:
  - title: 우리
    data: [52.7, 61.9, 47.9, 63.5, 75.0, 33.6]
  - title: 논문
    data: [53.0, 63.4, 47.5, 65.2, 74.0, 34.6]
tension: 0.2
width: 100%
labelColors: false
fill: false
...
series:
  - title: 우리
    data: [89.1, 85.0, 56.8, 84.6, 96.1, 86.0]
  - title: 논문
    data: [90.5, 87.8, 58.9, 90.0, 91.9, 90.4]
tension: 0.2
width: 100%
labelColors: false
fill: false
