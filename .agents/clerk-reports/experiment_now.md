...
| HyperGCL | **3.8 ± 0.2** (Δ **−18.4**) | **6.3 ± 0.2** (Δ **−24.2**) | **0.2 ± 0.0** (Δ **−1.2**) | **6.2 ± 0.0** (Δ **−5.3**) | **4.8 ± 0.0** (Δ **−19.4**) | **1.7 ± 0.0** (Δ **−30.2**) | O.O.M skip | — pending |
...
| SE-HSSL | **38.5 ± 0.0** (Δ **−0.0**) | **44.5 ± 0.1** (Δ **+0.1**) | **0.5 ± 0.2** (Δ **+0.2**) | **0.2 ± 0.0** (Δ **−0.5**) | **15.7 ± 2.3** (Δ **+0.7**) | **42.2 ± 0.3** (Δ **+0.4**) | — pending | — pending |
