...
run maskgae conda run --no-capture-output -n hgnn-pyg python MaskGAE/MaskGAE_train.py --data house --num_seeds 20 --lr 0.01 --device 1 --task node --alpha 0.003 --p 0.5
