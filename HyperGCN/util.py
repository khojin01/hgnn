...
class HyperGraphConvolution(Module):
    ...
    def __init__(self, a, b, reapproximate=True, device="cuda:0"):
        super(HyperGraphConvolution, self).__init__()
        self.a, self.b = a, b
        self.reapproximate, self.device = reapproximate, device
...
#         ipdb.set_trace()
        W, b = self.W.to(self.device), self.bias.to(self.device)
        HW = torch.mm(H, W)
