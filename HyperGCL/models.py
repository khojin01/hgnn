...
#         If there's hyperedge features, concat with Vpart decoder output features [V_feat||E_feat]
        ...
        self.mlp_edge = nn.Linear(args.MLP_hidden, 1)
        ...
        if self.All_num_layers == 0:
            ...
            self.proj_head = MLP(in_channels=args.MLP_hidden,
            ...
            self.decoder = nn.Sequential(nn.Linear(args.MLP_hidden, args.MLP_hidden), nn.ReLU(), nn.Linear(args.MLP_hidden, 2))
